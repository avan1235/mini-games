...
inline fun <reified T> envVarOrNull(name: String): T? = when (T::class) {
...
inline fun <reified T> envVar(name: String): T =
    envVarOrNull(name) ?: throw IllegalArgumentException("Env variable $name not defined")
